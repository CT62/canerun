    ...
    <main className="min-h-screen bg-slate-50 dark:bg-slate-950 transition-colors">
      ...
      <section className="relative overflow-hidden bg-gray-200 dark:bg-slate-800">
        ...
        <div className="relative max-w-4xl mx-auto px-6 pt-14 pb-20">
          <Link href="/services" className="inline-flex items-center gap-2 text-xs font-bold text-slate-700 dark:text-slate-300 hover:text-emerald-700 dark:hover:text-emerald-400 transition-all mb-10">
          ...
          >
            <div className="w-14 h-14 rounded-2xl bg-slate-900/5 dark:bg-white/10 border border-slate-900/10 dark:border-white/10 text-emerald-700 dark:text-emerald-400 flex items-center justify-center mb-6">
            ...
            <p className="text-slate-700 dark:text-slate-300 text-sm sm:text-base mt-4 max-w-xl leading-relaxed">{service.tagline}</p>
          </motion.div>
        </div>
      </section>
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 -mt-10 pb-24">
        ...
        >
          <div className="p-8 sm:p-10">
            <p className="text-[10px] font-bold text-slate-400 dark:text-slate-500 uppercase tracking-wide mb-3">About This Service</p>
            <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed max-w-2xl">{service.description}</p>
          </div>
