// Normalizes a customer-typed state (full name or abbreviation, any case) into the 2-letter
// code carriers actually expect — the shipping address form accepts free text, but
// ShipEngine/FedEx/UPS/USPS all require the code, not "Illinois". US-only: we only ship
// domestically.
const US_STATES = {
...
const KNOWN_CODES = new Set(Object.values(US_STATES));
